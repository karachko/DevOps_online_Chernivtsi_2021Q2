...
## Task 1
1. I created the account "karachko" on "Github" and installed "Git for Windows" (https://git-scm.com/download/win) 
...
9. I made git commit
- git init
10. I created the develop branch and checkout on it.
...
10.I created the branch with name “images” and checkout on it. 
- git checkout -b images
- mkdir images
- I added images folder with some images inside and did Commit*Add files( 0-04-0a-6decd25b097dbc48eddf0ad3537ea9314a5b20d1bd1be2bacac7c3b78b4e8c8d_62951ab.jpg  0-04-0537c2824fb2f941c06a8aa43c5e3fb6652fa156e868c8e1eb590dea42fb36b892_3f4a47b9.jpg) to the folder images
- git add images/\*.*
...
13. I created branch with name “styles” and checkout on it. I added styles folder with
...
14. I changed my index.html. I did Commit
- git add index.html
- git commit -m "Change file index.html"
...
- git merge images
- git merge styles
- The merge conflict had been appeared after the execution of the command "git merge styles"
```-$ git merge styles
...
- The error had been appeared ``` fatal: 'origin' does not appear to be a git repository
fatal: Could not read from remote repository. Please make sure you have the correct access rights and the repository exists.```
- Fix this error 
``` git remote add origin https://github.com/karachko/DevOps_online_Chernivtsi_2021Q2.git ```
- git push origin --all
18. I executed the command “git reflog“ and saved it content somewhere (not in the
