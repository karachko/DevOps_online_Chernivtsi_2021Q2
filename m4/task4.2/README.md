...
- The 1 floor with 2 groups of PC's(The first group-3 PC's, the second group -5  PC's).
    ...
    - all PC's from the first group were connected with Switch0 via (Copper Straight-through)).
    - all PC's from the second group were connected with Switch0(2) via (Copper Straight-through)).
...
- The 2 floor with 2 groups of PC's(The first group-3 PC's, the second group -5  PC's).
    ...
    - all PC's from the first group were connected with Switch0(1) via (Copper Straight-through)).
    - all PC's from the second group were connected with Switch0(3) via (Copper Straight-through)).
...
- The 3 floor with 2 groups of PC's(The first group-3 PC's, the second group -5  PC's).
    - Everyone PC's(The 3 floor, the first group) was assigned the IP-address 
    - PC0(4) 192.168.0.129/27
    - PC1(4) 192.168.0.130/27
    - PC2(4) 192.168.0.131/27
    - Everyone PC's(The 3 floor, the second group) was assigned the IP-address 
    - PC0(2)(1) 192.168.0.161/27
    - PC1(2)(1) 192.168.0.162/27
    - PC2(2)(1) 192.168.0.163/27
    - PC3(2)(1) 192.168.0.164/27
    - PC4(2)(1) 192.168.0.165/27
    - all PC's from the first group were connected with Switch0(4) via (Copper Straight-through)).
    - all PC's from the second group were connected with Switch0(2)(1) via (Copper Straight-through)).
 ...
 - The 4 floor with 2 groups of PC's(The first group-3 PC's, the second group -5  PC's).
    ...
    - all PC's from the first group were connected with Switch0(5) via (Copper Straight-through)).
    - all PC's from the second group were connected with Switch0(2)(2) via (Copper Straight-through)).
...
- The 3 building with 1 group of 6 PC's. 
    ...
    - PC4(3) 192.168.0.17
    - PC7 192.168.0.18
    - all PC's were connected with Switch0(3) via (Copper Straight-through)).
