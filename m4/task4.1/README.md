...
1. I created the new project with 4 PC's and 1 HUB(all PC's were connected with HUB via (Copper Straight-through)).
2. 
 - ![1.jpg](https://github.com/karachko/DevOps_online_Chernivtsi_2021Q2/blob/main/m4/task4.1/1.jpg)
3. Everyone PC's was assigned the IP-address 
- PC0 192.168.0.1
- PC1 192.168.0.2
- PC2 192.168.0.3
- PC3 192.168.0.4
...
7. I compared the information from **Simulation** and **PDU information**
...
8. I deleted the IP adress from everyone PC's. The transfer of the packages was failed.
...
10 . Everyone PC's was assigned the IP-address
- PC0 192.168.0.1
- PC1 192.168.0.2
- PC2 192.168.0.3
- PC3 192.168.0.4
...
11. I checked the work of the network 
...
The Switches and Router were connected via **Fiber**
19. Everyone (РС4 – РС7) was assigned the IP-address
- PC4 192.168.1.1
- PC5 192.168.1.2
- PC6 192.168.1.3
- PC7 192.168.1.4
- the mask was : 255.255.255.0.
20. Ports of the Router-PT were switched on  (On) and  assigned the IP-address( one 192.168.0.5, and another 192.168.1.5)
...
- Everyone PC's ,from the second network (192.168.1.),was assigned  the **default gateway** 192.168.1.5 
22.  I checked the work of the network 
