...
- (81.jpg)![8.1.jpg](https://github.com/karachko/DevOps_online_Chernivtsi_2021Q2/blob/main/m3/8.1.jpg)
2) 
- sudo mysql
- REVOKE ALL PRIVILEGES ON * . * FROM 'newuser'@'localhost';
- quit
- sudo mysql -u newuser -p
- (82.jpq)[8.2.jpg](https://github.com/karachko/DevOps_online_Chernivtsi_2021Q2/blob/main/m3/8.2.jpg)
